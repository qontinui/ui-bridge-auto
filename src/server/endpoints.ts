...
import type { HighlightOptions, TextAssertionOptions, ScreenshotAssertionOptions, CoordinatePoint, CoordinateSpace, IOCRProvider } from "../visual/types";
